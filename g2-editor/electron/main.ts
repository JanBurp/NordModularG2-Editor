	...
	const template: Electron.MenuItemConstructorOptions[] = [
		...
		},
		{
			...
			submenu: [
				...
				{ type: "separator" },
				{ label: "Slot A", click: () => win!.webContents.send("menu:action", "slot-A"), accelerator: "CommandOrControl+Shift+A" },
				{ label: "Slot B", click: () => win!.webContents.send("menu:action", "slot-B"), accelerator: "CommandOrControl+Shift+B" },
				{ label: "Slot C", click: () => win!.webContents.send("menu:action", "slot-C"), accelerator: "CommandOrControl+Shift+C" },
