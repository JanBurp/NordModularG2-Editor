...
const CLK_FORMAT =
	'0 ~ 1/64T, 4 ~ 1/64, 8 ~ 1/32T, 12 ~ 1/64D, 16 ~ 1/32, 20 ~ 1/16T, 24 ~ 1/32D, 28 ~ 1/16, 32 ~ 1/16, 36 ~ 1/8T, 40 ~ 1/8T, 44 ~ 1/16D, 48 ~ 1/16D, 52 ~ 1/8, 56 ~ 1/8, 60 ~ 1/4T, 64 ~ 1/4T, 68 ~ 1/8D, 72 ~ 1/8D, 76 ~ 1/4, 80 ~ 1/4, 84 ~ 1/2T, 88 ~ 1/2T, 92 ~ 1/4D, 96 ~ 1/4D, 100 ~ 1/2, 104 ~ 1/2, 108 ~ 1/1T, 112 ~ 1/2D, 116 ~ 1/1, 120 ~ 1/1D, 124 ~ 2/1';
...
const parammap: Record<string, ParamDefinition> = {
	...
	BipPosNeg: { names: ['Bip', 'Pos', 'Neg'], width: 18, low: 0, high: 2, def: 0, defin: ['0 ~ Bip, 1 ~ Pos, 2 ~ Neg'], comments: '' },
	BipUni: { names: ['Bip', 'Uni'], width: 18, low: 0, high: 1, def: 0, defin: ['0 ~ Bip, 1 ~ Uni'], comments: 'Determines display for [LevBipUni]' },
	ClassicSlope: { mode: 'HR', names: ['12', '18', '24'], low: 0, high: 2, def: 0, defin: ['0 ~ 12, 1 ~ 18, 2 ~ 24'], comments: '' },
	...
	DriverType: { width: 32, names: ['Reed', 'Bow', 'Lip', 'Malet'], low: 0, high: 3, def: 0, defin: ['0 ~ Reed, 1 ~ Bow, 2 ~ Lip, 3 ~ Malet'], comments: '' },
	...
	FltSlope_1: { mode: 'HR', names: ['6', '12'], low: 0, high: 1, def: 1, defin: ['0 ~ 6, 1 ~ 12'], comments: '' },
	FltSlope_2: { mode: 'HR', names: ['12', '24'], low: 0, high: 1, def: 0, defin: ['0 ~ 12, 1 ~ 24'], comments: '' },
	...
	InternalMaster: { width: 34, low: 0, high: 1, def: 0, defin: ['0 ~ Internal, 1 ~ Master'], comments: '' },
	...
	LfoRange_3: { width: 24, f: 'rateLo', low: 0, high: 3, def: 1, defin: ['0 ~ Sub, 1 ~ Lo, 2 ~ Hi, 3 ~ BPM'], comments: 'Determines [LfoRate_3]' },
	...
	LpBpHp2: { mode: 'VR', names: ['LP', 'BP', 'HP'], low: 0, high: 2, def: 0, defin: ['0 ~ LP, 1 ~ BP, 2 ~ HP'], comments: '' },
	...
	TrigBtn: { width: 18, names: ['Ch#'], low: 0, high: 1, def: 0, defin: ['0 ~ Off, 1 ~ On'], trigger: true, comments: '' },
	...
	OscWaveform_2: { width: 22, height: 18, img: 'ModeWave2', low: 0, high: 5, def: 0, defin: ['0 ~ Sine, 1 ~ Tri, 2 ~ Saw, 3 ~ Square, 4 ~ Pulse 25%, 5 ~ Pulse 10%'], comments: '' },
	OscWaveform_3: { width: 22, height: 16, img: 'ModeShpB', low: 0, high: 7, def: 0, defin: ['0 ~ Sine1, 1 ~ Sine2, 2 ~ Sine3, 4 ~ TriSaw, 5 ~ DoubleSaw, 6 ~ Pulse, 7 ~ SymPuls'], comments: '' },
	...
	RandomAStepProb: { width: 24, low: 0, high: 3, def: 0, defin: ['0 ~ 25%, 1 ~ 50%, 2 ~ 75%, 3 ~ 100%'], comments: '' },
	...
	ResonAlg: { names: ['String1', 'String2', 'Tube1', 'Tube2', 'Tube3'], rows: 1, width: 60, low: 0, high: 4, def: 0, defin: ['0 ~ String1, 1 ~ String2, 2 ~ Tube1, 3 ~ Tube2, 4 ~ Tube3'], canLabel: true, comments: '' },
	...
	Rnd_1: { width: 32, height: 12, low: 0, high: 1, def: 0, defin: ['0 ~ Rnd1, 1 ~ Rnd2'], comments: '' },
	RndEdge: { width: 24, low: 0, high: 4, def: 0, defin: ['0 ~ 0%, 1 ~ 25%, 2 ~ 50%, 3 ~ 75%, 4 ~ 100%'], comments: '' },
	RndStepPulse: { width: 46, height: 12, low: 0, high: 1, def: 0, defin: ['0 ~ Step, 1 ~ Pulse'], comments: '' },
