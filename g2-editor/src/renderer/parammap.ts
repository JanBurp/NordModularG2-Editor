...
const parammap: Record<string, ParamDefinition> = {
	...
	Pad_1: { width: 24, low: 0, high: 1, def: 0, defin: ['0 ~ 0 dB, 1 ~ +6 dB'], comments: '' },
	Pad_2: { width: 24, low: 0, high: 1, def: 0, defin: ['0 ~ 0 dB, 1 ~ -6 dB'], comments: '' },
	Pad_3: { width: 24, low: 0, high: 2, def: 0, defin: ['0 ~ 0 dB, 1 ~ -6 dB, 2 ~ -12 dB'], comments: '' },
	Pad_4: { width: 24, low: 0, high: 3, def: 1, defin: ['0 ~ -12 dB, 1 ~ -6 dB, 2 ~ 0 dB,3 ~ +6 dB'], comments: '' },
...
export function adsrT(i: number): string {
	const t = [0.5, 0.6, 0.7, 0.9, 1.1, 1.3, 1.5, 1.8, 2.1, 2.5, 3.0, 3.5, 4.0, 4.7, 5.5, 6.3, 7.3, 8.4, 9.7, 11.1, 12.7, 14.5, 16.5, 18.7, 21.2, 24.0, 27.1, 30.6, 34.4, 38.7, 43.4, 48.6, 54.3, 60.6, 67.6, 75.2, 83.6, 92.8, 103, 114, 126, 139, 153, 169, 186, 204, 224, 246, 269, 295, 322, 352, 384, 419, 456, 496, 540, 586, 636, 690, 748, 810, 876, 947, 1020, 1100, 1190, 1280, 1380, 1490, 1600, 1720, 1850, 1990, 2130, 2280, 2450, 2620, 2810, 3000, 3210, 3430, 3660, 3910, 4170, 4450, 4740, 5050, 5370, 5720, 6080, 6470, 6870, 7300, 7750, 8220, 8720, 9250, 9800, 10400, 11000, 11600, 12300, 13000, 13800, 14600, 15400, 16200, 17100, 18100, 19100, 20100, 21200, 22400, 23500, 24800, 26100, 27500, 28900, 30400, 32000, 33600, 35300, 37100, 38900, 40900, 42900, 45000][Math.floor(i)];
...
const _clk = ['64/1', '48/1', '32/1', '24/1', '16/1', '12/1', '8/1', '6/1', '4/1', '3/1', '2/1', '1/1D', '1/1', '1/2D', '1/1T', '1/2', '1/4D', '1/2T', '1/4', '1/8D', '1/4T', '1/8', '1/16D', '1/8T', '1/16', '1/32D', '1/16T', '1/32', '1/64D', '1/32T', '1/64', '1/64T'];
...
export function rateLo(i: number, con: unknown, tw: unknown): string | undefined {
	...
	const bf = [{ b: 0.09259, f: 1.06733 }, { b: 0.64, f: 1.05946309436 }, { b: 10.3, f: 1.05946309436 }, 0, 1][(con as Record<string, { l: number }>)[(tw as { ca: number[] }).ca[1]].l];
