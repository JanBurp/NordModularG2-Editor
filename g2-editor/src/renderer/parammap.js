...
ClipShape: {low:0,high:1,def:0,defin:["0 ~ Asym, 1 ~ Sym"],comments:""},
...
CombType: {low:0,high:2,def:0,defin:["0 ~ Notch, 1 ~ Peak, 2 ~ Deep"],comments:""},
...
EnvShape_3: {bmp:"Curve",w:20,maskh:9,names:["","","",""],low:0,high:3,def:0,defin:["0 ~ LogExp, 1 ~ LinExp, 2 ~ ExpExp, 3 ~ LinLin"],comments:""},
...
FlipFlopMode: {img:"ModeFF",h:25,low:0,high:1,def:0,defin:["0 ~ D type, 1 ~ SR type"],comments:""},
...
FltPhaseType: {low:0,high:2,def:0,defin:["0 ~ Notch, 1 ~ Peak, 2 ~ Deep"],comments:""},
...
FreqMode_2: {names:["Semi","Freq","Fac"],f:"OscFreq",low:0,high:2,def:0,defin:["0 ~ Semi, 1 ~ Freq, 2 ~ Fac"],comments:""},
FreqMode_3: {names:["Semi","Freq","Fac","Part"],f:"OscFreq",low:0,high:3,def:0,defin:["0 ~ Semi, 1 ~ Freq, 2 ~ Fac, 3 ~ Part"],comments:""},
...
GateMode: {img:"ModeGate",h:-21,low:0,high:5,def:0,defin:["0 ~ AND, 1 ~ NAND, 2 ~ OR, 3 ~ NOR, 4 ~ XOR, 5 ~ XNOR"],comments:""},
...
LogicDelayMode: {img:"ModeDelay",low:0,high:2,def:0,defin:["0 ~ Positive edge delay, 1 ~ Negative edge delay, 2 ~ Cycle delay"],comments:""},
...
MonoKeyMode: {names:["Last","Lo","Hi"],width:23,low:0,high:2,def:0,defin:["0 ~ Last, 1 ~ Lo, 2 ~ Hi"],comments:""},
...
OutTypeLfo: {low:0,high:5,def:4,defin:["0 ~ Pos, 1 ~ PosInv, 2 ~ Neg, 3 ~ NegInv, 4 ~ Bip, 5 ~ BipInv"],comments:""},
OverdriveType: {low:0,high:3,def:0,defin:["0 ~ Soft, 1 ~ Hard, 2 ~ Fat, 3 ~ Heavy"],comments:""},
Pad_1: {low:0,high:1,def:0,defin:["0 ~ 0 dB, 1 ~ +6 dB"],comments:""},
Pad_2: {low:0,high:1,def:0,defin:["0 ~ 0 dB, 1 ~ -6 dB"],comments:""},
Pad_3: {low:0,high:2,def:0,defin:["0 ~ 0 dB, 1 ~ -6 dB, 2 ~ -12 dB"],comments:""},
Pad_4: {low:0,high:3,def:1,defin:["0 ~ -12 dB, 1 ~ -6 dB, 2 ~ 0 dB,3 ~ +6 dB"],comments:""},
...
PolyMono: {low:0,high:1,def:0,defin:["0 ~ Poly, 1 ~ Mono"],comments:""},
PosNegInv: {low:0,high:3,def:0,defin:["0 ~ Pos, 1 ~ PosInv, 2 ~ Neg, 3 ~ NegInv"],comments:""},
PosNegInvBip: {low:0,high:4,def:0,defin:["0 ~ Pos, 1 ~ PosInv, 2 ~ Neg, 3 ~ NegInv, 4 ~ Bip"],comments:""},
PosNegInvBipInv: {low:0,high:5,def:0,defin:["0 ~ Pos, 1 ~ PosInv, 2 ~ Neg, 3 ~ NegInv, 4 ~ Bip, 5 ~ BipInv"],comments:""},
...
PulseMode: {img:"ModePulse",low:0,high:1,def:0,defin:["0 ~ Positive edge trigger, 1 ~ Negative edge trigger"],comments:""},
...
Source_1: {names:["1/2","3/4"],width:17,low:0,high:1,def:0,defin:["0 ~ FX 1/2, 1 ~ FX 3/4"],comments:""},
Source_2: {names:["1/2","3/4","1/2","3/4"],width:17,low:0,high:3,def:0,defin:["0 ~ In 1/2, 1 ~ In 3/4, 2 ~ Bus 1/2, 3 ~ Bus 3/4"],comments:""},
Source_3: {names:["In","Bus"],width:19,low:0,high:1,def:0,defin:["0 ~ In, 1 ~ Bus"],comments:""},
...
function adsrT(i) {
    var t = [
        0.5, 0.6, 0.7, 0.9, 1.1, 1.3, 1.5, 1.8, 2.1, 2.5, 3.0, 3.5, 4.0, 4.7, 5.5,
        6.3, 7.3, 8.4, 9.7, 11.1, 12.7, 14.5, 16.5, 18.7, 21.2, 24.0, 27.1, 30.6,
        34.4, 38.7, 43.4, 48.6, 54.3, 60.6, 67.6, 75.2, 83.6, 92.8, 103, 114, 126,
        139, 153, 169, 186, 204, 224, 246, 269, 295, 322, 352, 384, 419, 456, 496,
        540, 586, 636, 690, 748, 810, 876, 947, 1020, 1100, 1190, 1280, 1380, 1490,
        1600, 1720, 1850, 1990, 2130, 2280, 2450, 2620, 2810, 3000, 3210, 3430,
        3660, 3910, 4170, 4450, 4740, 5050, 5370, 5720, 6080, 6470, 6870, 7300,
        7750, 8220, 8720, 9250, 9800, 10400, 11000, 11600, 12300, 13000, 13800,
        14600, 15400, 16200, 17100, 18100, 19100, 20100, 21200, 22400, 23500, 24800,
        26100, 27500, 28900, 30400, 32000, 33600, 35300, 37100, 38900, 40900, 42900,
        45000,
    ][Math.floor(i)];
...
function rateLo(i, con, tw) {
    if (!tw) return;
    i = con[tw.ca[0]].l;
    var bf = [
        { b: 0.09259, f: 1.06733 },
        { b: 0.64, f: 1.05946309436 },
        { b: 10.3, f: 1.05946309436 },
        0,
        1,
    ][con[tw.ca[1]].l];
    if (bf == 0) return rateBPM(i).slice(0, -3);
    if (bf == 1) return _clk[i >> 2];
    var r = bf.b / Math.pow(bf.f, 64 - Math.floor(i));
    var sec = 1 / r;
    sec = sec.toFixed(1);
    return (r < 0.1 && sec + "s") || r.toFixed((r < 10 && 2) || 1) + "Hz";
}

function OscFreq(i, con, tw) {
    if (!tw) return;
    var c = Math.floor(con[tw.ca[0]].l);
    var f = Math.floor(con[tw.ca[1]].l);
    var m = con[tw.ca[2]].l;
    var r;
    switch (m) {
        case 0:
            return (
                ...
                "\xA0\xA0\xA0" +
                (f > 63 ? "+" : "") +
                (((f - 64) * 1) / 1.28).toFixed(0)
            );
        case 1:
            r =
                339.134 /
                Math.pow(1.05946309436, 64 - (c - 0.5 + ((f - 63) * 1) / 128));
            return r < 1000
                ? r.toFixed((r < 100 && 3) || 2) + "Hz"
                : (r / 1000).toFixed((r < 10000 && 3) || 2) + "kHz";
        case 2:
            r =
                1.0288383386318507 /
                Math.pow(1.05946309436, 64 - (c - 0.5 + ((f - 63) * 1) / 128));
...
function filterFreq(i) {
    var r = 554.4 / Math.pow(1.05946309436, 64 - i);
    return r < 1000
        ? r.toFixed((r < 100 && 3) || 2) + "Hz"
        : (r / 1000).toFixed((r < 10000 && 3) || 2) + "kHz";
}
function filterFreq2(i) {
    var r = 1290 / Math.pow(1 + 0.05946309436 / 1.465, 64 - i);
    return r < 1000
        ? r.toFixed((r < 100 && 3) || 2) + "Hz"
        : (r / 1000).toFixed((r < 10000 && 3) || 2) + "kHz";
}
function filterFreq1(i) {
    var r = 329.63 / Math.pow(1.05946309436, 64 - i);
    return r < 1000
        ? r.toFixed((r < 100 && 3) || 2) + "Hz"
        : (r / 1000).toFixed((r < 10000 && 3) || 2) + "kHz";
}

// Attach formatting functions to window for global access
window.OscFreq = OscFreq;
window.rateLo = rateLo;
window.adsrT = adsrT;
window.adsrL = adsrL;
window.filterFreq = filterFreq;
window.filterFreq1 = filterFreq1;
window.filterFreq2 = filterFreq2;

// ES module exports
export const parammap = window.parammap;
export {
  OscFreq,
  rateLo,
  adsrT,
...
export default window.parammap;
