...
function oscShpgraph(_ve: VisualElement, vals: number[]): GraphPathResult {
	const dp: OscEntry[] = [
		...
		[
			[0, 0.5, 0.2643, 0, 0.5, 0, 0.7357, 0, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.264, 1.0, 1.5, 1.0, 1.736, 1.0, 2.0, 0.5, 2.0, 0.5],
			[0.3294, 0.4234, 0.6492, 0.3103, 0.95, 0.001531, 0.9667, 0.1815, 0.9833, 0.3615, 1.0, 0.5415, 1.017, 0.6948, 1.033, 0.8482, 1.05, 1.002, 1.382, 0.6305, 1.692, 0.5297, 2.0, 0.5],
		],
		[
			[0, 0.5, 0.2643, 0, 0.5, 0, 0.7357, 0, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.264, 1.0, 1.5, 1.0, 1.736, 1.0, 2.0, 0.5, 2.0, 0.5],
			[0.05, -0.05072, -0.05, -0.1, 0.5, 0.15, 1.05, -0.1, 0.95, -0.05072, 1.0, 0.4993, 1.05, 1.05, 0.95, 1.1, 1.5, 0.8485, 2.05, 1.1, 1.95, 1.05, 2.0, 0.4993],
		],
...
function adsrGraph(_ve: VisualElement, vals: number[]): GraphPathResult {
	const segs = [
		new EnvSegment(lv(vals, 1, 0), 0),
		new EnvSegment(lv(vals, 2, 0), 127 - lv(vals, 3, 0)),
		new EnvSegment(lv(vals, 4, 0), 127),
	];
	segs[1].sustain = true;
...
function adsrMGraph(_ve: VisualElement, vals: number[]): GraphPathResult {
	const segs = [
		new EnvSegment(lv(vals, 0, 0), 0),
		new EnvSegment(lv(vals, 1, 0), 127 - lv(vals, 2, 0)),
		new EnvSegment(lv(vals, 3, 0), 127),
	];
	segs[1].sustain = true;
...
function ahdMGraph(_ve: VisualElement, vals: number[]): GraphPathResult {
	const segs = [
		new EnvSegment(lv(vals, 0, 0), 0),
		new EnvSegment(lv(vals, 1, 0), 0),
		new EnvSegment(lv(vals, 2, 0), 127),
	];
...
const dxAla: { x: number; y: number }[][] = [
	[{ x: 46, y: 51 }, { x: 46, y: 35 }, { x: 78, y: 51 }, { x: 78, y: 35 }, { x: 78, y: 19 }, { x: 78, y: 3 }],
	[{ x: 46, y: 51 }, { x: 46, y: 35 }, { x: 46, y: 19 }, { x: 78, y: 51 }, { x: 78, y: 35 }, { x: 78, y: 19 }],
	[{ x: 28, y: 51 }, { x: 28, y: 35 }, { x: 60, y: 51 }, { x: 60, y: 35 }, { x: 92, y: 51 }, { x: 92, y: 35 }],
	[{ x: 28, y: 51 }, { x: 28, y: 35 }, { x: 60, y: 51 }, { x: 60, y: 35 }, { x: 92, y: 35 }, { x: 92, y: 19 }],
	[{ x: 83, y: 51 }, { x: 83, y: 35 }, { x: 83, y: 19 }, { x: 55, y: 51 }, { x: 55, y: 35 }, { x: 26, y: 35 }],
	[{ x: 99, y: 51 }, { x: 99, y: 35 }, { x: 44, y: 51 }, { x: 17, y: 35 }, { x: 44, y: 35 }, { x: 72, y: 35 }],
	[{ x: 43, y: 51 }, { x: 43, y: 35 }, { x: 72, y: 51 }, { x: 72, y: 35 }, { x: 43, y: 19 }, { x: 72, y: 19 }],
	[{ x: 54, y: 51 }, { x: 26, y: 35 }, { x: 55, y: 35 }, { x: 55, y: 19 }, { x: 83, y: 35 }, { x: 83, y: 19 }],
	[{ x: 54, y: 51 }, { x: 26, y: 35 }, { x: 55, y: 35 }, { x: 83, y: 35 }, { x: 83, y: 19 }, { x: 83, y: 3 }],
	[{ x: 28, y: 51 }, { x: 28, y: 35 }, { x: 28, y: 19 }, { x: 60, y: 51 }, { x: 93, y: 51 }, { x: 60, y: 35 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 11, y: 35 }, { x: 108, y: 51 }, { x: 108, y: 35 }, { x: 76, y: 35 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 11, y: 35 }, { x: 76, y: 51 }, { x: 108, y: 51 }, { x: 76, y: 35 }],
	[{ x: 11, y: 51 }, { x: 11, y: 35 }, { x: 44, y: 51 }, { x: 76, y: 51 }, { x: 108, y: 51 }, { x: 76, y: 35 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 44, y: 35 }, { x: 76, y: 51 }, { x: 108, y: 51 }, { x: 76, y: 35 }],
	[{ x: 1, y: 51 }, { x: 31, y: 51 }, { x: 61, y: 51 }, { x: 90, y: 51 }, { x: 120, y: 51 }, { x: 90, y: 35 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 44, y: 35 }, { x: 108, y: 51 }, { x: 76, y: 35 }, { x: 108, y: 35 }],
	[{ x: 28, y: 51 }, { x: 28, y: 35 }, { x: 60, y: 51 }, { x: 60, y: 35 }, { x: 60, y: 19 }, { x: 92, y: 51 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 76, y: 51 }, { x: 76, y: 35 }, { x: 108, y: 51 }, { x: 108, y: 35 }],
	[{ x: 11, y: 51 }, { x: 44, y: 51 }, { x: 76, y: 51 }, { x: 76, y: 35 }, { x: 76, y: 19 }, { x: 108, y: 51 }],
	[{ x: 1, y: 51 }, { x: 31, y: 51 }, { x: 61, y: 51 }, { x: 90, y: 51 }, { x: 120, y: 51 }, { x: 120, y: 35 }],
	[{ x: 1, y: 51 }, { x: 25, y: 51 }, { x: 49, y: 51 }, { x: 73, y: 51 }, { x: 97, y: 51 }, { x: 121, y: 51 }],
];
...
const dxAlb: { i: number; d: string }[] = [
	...
	{ i: 5, d: 'M 71.99,46.1 61.8,50.78 M 34.16,46.1 44.35,50.78 m 36.07,-4.71 0,2.44 11.55,0 -0.1,-16.47 -11.6,0 0,2.79 m -27.1,11.15 0,18.97 54.53,0 0,-19.07' },
	...
	{ i: 7, d: 'M 82.83,46.1 71.68,50.78 M 43.2,46.1 54.35,50.78 m 37.35,-18.31 11.6,0.1 -0.1,-16.47 -11.62,0 0,2.6 m -28.24,11.68 0,34.63 m 28.4,-18.82 0,-16.19' },
	...
	{ i: 8, d: 'm 63.34,34.87 0,30.07 M 82.83,46.1 71.68,50.78 M 43.2,46.1 54.35,50.78 m 0.1,0 17.21,0 0,11.3 -17.21,0 z m 37.3,-15.87 0,-20.75 m -28.43,34.5 8.01,0 3.69,-1.84 -0.1,-14.71 -11.62,0 0,2.6' },
	{ i: 9, d: 'm 69.11,34.57 0,-3.13 12.64,0 0,15.99 m -4.43,-1.39 15.16,4.74 m -56.07,-21.97 0,36.13 64.99,0 0,-3.67 M 68.68,46 l 0,19' },
	{ i: 10, d: 'm 93.4,46.04 14.9,4.74 m -87.91,-16.21 0,-3.13 12.64,0 0,15.99 M 28.6,46.04 43.76,50.78 M 20.41,46 l 0,18.94 96.69,0 0,-18.94 m -64.42,14 0,5' },
	{ i: 11, d: 'M 93.4,46.04 108.3,50.78 M 28.6,46.04 43.76,50.78 M 20.39,34.57 20.39,31.44 33.03,31.44 33.03,47.43 M 20.41,46 20.41,64.94 117.1,64.94 117.1,62 M 52.68,62 52.68,65 M 84.75,46 84.75,65' },
	{ i: 12, d: 'M 75.74,46.04 60.84,50.78 M 93.4,46.04 108.3,50.78 M 84.25,34.38 84.25,31.25 96.95,31.25 96.95,47.24 M 43.67,50.81 60.89,50.81 60.89,62.09 43.67,62.09 z M 20.41,46 20.41,64.94 117.1,64.94 117.1,62 M 52.68,62 52.68,65 M 84.75,46 84.75,65' },
	{ i: 13, d: 'M 93.4,46.04 108.3,50.78 M 84.25,34.38 84.25,31.25 96.95,31.25 96.95,47.24 M 20.41,61.95 20.41,64.94 117.1,64.94 117.1,62 M 52.68,46 52.68,64.87 M 84.75,46 84.75,65' },
	{ i: 14, d: 'M 39.04,62 39.04,65 M 90.5,46.04 77.83,50.78 M 107.9,46.04 120.3,50.78 M 99.01,34.95 99.01,31.82 111.8,31.82 111.8,47.56 M 9.542,61.67 9.542,64.94 129.1,64.94 129.1,62 M 69.04,62 69.04,65 M 98.75,46 98.75,65' },
	{ i: 14, d: 'M 39.04,62 39.04,65 M 107.9,46.04 120.3,50.78 M 99.01,34.95 99.01,31.82 111.8,31.82 111.8,47.56 M 9.542,61.67 9.542,64.94 129.1,64.94 129.1,62 M 69.04,62 69.04,65 M 98.75,46 98.75,65' },
	{ i: 15, d: 'M 93.4,46.04 108.3,50.78 M 117.1,34.38 117.1,31.56 129.6,31.56 129.6,48.22 117.1,48.22 M 20.41,61.95 20.41,64.94 117.1,64.94 117.1,45.86 M 52.68,46 52.68,64.87' },
	{ i: 15, d: 'M 93.4,46.04 108.3,50.78 M 52.69,34.38 52.69,31.56 65.19,31.56 65.19,48.22 52.69,48.22 M 20.41,61.95 20.41,64.94 117.1,64.94 117.1,45.86 M 52.68,46 52.68,64.87' },
	...
	{ i: 17, d: 'M 117.1,34.38 117.1,31.25 129.9,31.25 129.9,48.13 117.1,48.13 M 20.41,61.95 20.41,64.94 117.1,64.94 117.1,45.72 M 52.68,62.18 52.68,64.87 M 84.75,46 84.75,65' },
	{ i: 18, d: 'M 84.75,18.38 84.75,15.25 97.55,15.25 97.55,32.13 84.75,32.13 M 20.41,61.95 20.41,64.94 117.1,64.94 117.1,61.82 M 52.68,62.18 52.68,64.87 M 84.75,29.9 84.75,65' },
	{ i: 19, d: 'M 39.04,62 39.04,65 M 129.4,34.92 129.4,31.79 116.6,31.79 116.6,48.32 129.1,48.32 M 9.542,61.67 9.542,64.94 129.1,64.94 129.1,45.67 M 69.04,62 69.04,65 M 98.75,61.54 98.75,65' },
	{ i: 20, d: 'M 33.06,62 33.06,65 M 129.4,50.92 129.4,47.79 116.9,47.79 116.9,63.67 129.1,63.67 M 80.82,61.54 80.82,65 M 57.08,62 57.08,65 M 9.542,61.67 9.542,64.94 129.1,64.94 129.1,61.82 M 105.5,62 105.5,65' },
];
