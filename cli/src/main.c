...
static int dispatch_command(const char *command, int argc, char **argv, int i) {
    ...
    if (strcmp(command, "set-cable-color") == 0) {
        /* set-cable-color <slot> <va|fx> <color:0-6> <from-mod> <0|1> <from-con> <to-mod> <0|1> <to-con> */
        if (i + 9 >= argc) {
    ...
    if (strcmp(command, "set-module-name") == 0) {
        /* set-module-name <slot> <va|fx> <module-id> <name> */
        if (i + 4 >= argc) {
    ...
    if (strcmp(command, "set-module-mode") == 0) {
        /* set-module-mode <slot> <va|fx> <module-id> <param-idx> <value> */
        if (i + 5 >= argc) {
