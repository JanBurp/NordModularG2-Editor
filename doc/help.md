...
- **Run** — toggle clock running/stopped
...
- **Set Color** — pick from 10 color swatches

## Parameters

| Control | Drag | Double-click |
|---|---|---|
...
| Right-click connected jack | Context menu |
...
| `Cmd+1–4` | Select slot A–D |
| `Cmd+Opt+1–8` | Select variation 1–8 |
| `Cmd+E` | Toggle Voice/FX area |
| `Cmd+T` | Toggle modules panel |
| `Cmd+B` | Toggle browser panel |
